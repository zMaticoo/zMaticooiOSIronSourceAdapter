#
# Be sure to run `pod lib lint ISzMaticooAdapter.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
This is zMaticoo iOS SDK IronSource Adaper.
                       DESC
  ...
  # s.resource_bundles = {
  #   'ISzMaticooAdapter' => ['ISzMaticooAdapter/Assets/*.png']
  # }
